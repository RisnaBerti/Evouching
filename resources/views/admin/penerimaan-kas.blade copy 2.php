                                ...
                                <div class="row">
                                    ...
                                    <div class="col-5 align-items-start">
                                        ...
                                        <div class="input-group input-group-sm mb-1">
                                            ...
                                            <input name="no_resi_terima_kas" type="text" class="form-control"
                                                id="no_resi_terima_kas" aria-label="Sizing example input"
                            ...
                            "render": function(data, type, row) {
                                ...
                                if (row.bukti_transaksi == null) {
                                    ...
                                    return '<a class="dropdown-item item-ubah-penerimaankas" href="#" data-ip="' +
                                        ...
                                        '" data-kp="' +
                                        row.keterangan_permohonan +
                                        '"><i class="fas fa-edit btn btn-icon btn-light-primary item-ubah-penerimaankas"></i></a> <span class="badge bg-success">Bukti Telah Di Unggah</span>';
                                }
                            },
                            padding: '5px',
                        }
