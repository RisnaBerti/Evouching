            ...
            <div class="card card-custom bg-gray-100 card-stretch gutter-b">
                ...
                <div class="card-body p-0 position-relative overflow-hidden">
                    ...
                    <div class="card-rounded-bottom"
                        ...
                        <h3 class="card-title font-weight-bolder text-white text-center">Selamat Datang <br> Dashboard Bendahara</h3>
                    ...
                    <div class="card-spacer mt-n25">
                        ...
                        <div class="row m-0">
                            ...
                            <div class="col bg-light-white px-6 py-8 rounded-xl mb-7">
                                ...
                                <span class="font-weight-bold text-muted  font-size-sm">{{ $danabank }}</span>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function get() {
                ...
                $.get("{{ url('/activiti-bendahara/get') }}", {
                    ...
                    $.each(res, function(indexRow, value) {
                        ...
                        } else if (value.status_permohonan == '0') {
