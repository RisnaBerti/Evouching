            ...
            <div class="login-container order-2 order-lg-1 d-flex flex-center flex-row-fluid px-7 pt-lg-0 pb-lg-0 pt-4 pb-6 bg-white">
                ...
                <div class="login-content d-flex flex-column pt-lg-0 pt-12">
                    ...
                    <div class="login-form">
                        <!--begin::Form-->
                        <form method="POST" action="{{ url('login') }}" class="form" id="kt_login_singin_form">
                            @csrf
                            <!--begin::Title--> 
                            <div class="pb-5 pb-lg-15">
                                ...
                                {{-- <div class="text-muted font-weight-bold font-size-h4">
                                    New Here?
                                    <a href="{{ asset('custom/pages/login/login-4/signup.html') }}" class="text-primary font-weight-bolder">Create Account</a>
                                </div> --}}
                            </div>
                            <!--begin::Title-->
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg border-0" type="text" name="email" id="email" autocomplete="off"/>
                            </div>
                            <!--end::Form group-->
