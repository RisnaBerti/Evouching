        ...
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
            ...
            <ul class="menu-nav">
                ...
                <li class="menu-item " aria-haspopup="true">
                    <a href="{{ url('/dashboard-pemohon') }}" class="menu-link">
                ...
                <li class="menu-item " aria-haspopup="true">
                    <a href="{{ url('/permohonan-pemohon/{id}') }}" class="menu-link">
                        <span class="svg-icon menu-icon svg-icon-primary">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <!-- START PENGAJUAN DANA MENU -->
                <li class="menu-item " aria-haspopup="true">
                    <a href="{{ url('/detail-permohonan') }}" class="menu-link">
                        <span class="svg-icon menu-icon svg-icon-primary">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <span class=" menu-text">Detail Permohonan Dana</span>
                    </a>
                </li>
                <!-- END PENGAJUAN DANA MENU -->
                ...
                <li class="menu-item menu-item-submenu " aria-haspopup="true" data-menu-toggle="hover">
                    ...
                    <div class="menu-submenu">
                        ...
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item " aria-haspopup="true">
                                <a href="{{ url('/profile-pemohon') }}" class="menu-link">
                                    <span class="svg-icon menu-icon svg-icon-primary">
                            ...
                            <li class="menu-item menu-item-submenu " aria-haspopup="true" data-menu-toggle="hover">
                                <a href="{{ url('/change-password-pemohon') }}" class="menu-link menu-toggle">
                                    <span class="svg-icon menu-icon svg-icon-primary">
