...
<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
    ...
    <div class="brand flex-column-auto" id="kt_brand">
        ...
        <a href="{{ url('') }}" class="brand-logo">
            ...
            <h4 style="color:white; font-style: italic;">E-Vouching GSC</h4>
        </a>
        <!--end::Logo-->
        <!--begin::Logo-->
    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        ...
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
            ...
            <ul class="menu-nav">
                ...
                <li class="menu-item " aria-haspopup="true">
                    <a href="{{ url('/permohonan-bendahara') }}" class="menu-link">
                        <span class="svg-icon menu-icon svg-icon-primary">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <li class="menu-item menu-item-submenu " aria-haspopup="true" data-menu-toggle="hover">
                    ...
                    <div class="menu-submenu">
                        ...
                        <ul class="menu-subnav">
                            ...
                            <!--MENU PENERIMAAN KAS-->
                            <li class="menu-item " aria-haspopup="true">
                                <a href="{{ url('/penerimaankas') }}" class="menu-link">
                                    <span class="svg-icon menu-icon svg-icon-primary">
                                    ...
                                    <span class="menu-text">Penerimaan Kas</span>
                                </a>
                            </li>
                            <!-- END MENU PENERIMAAN KAS-->
                            <!-- END MENU PEMBAYARAN KAS-->
                            <li class="menu-item menu-item-submenu " aria-haspopup="true" data-menu-toggle="hover">
                                <a href="{{ url('/pembayarankas') }}" class="menu-link">
                                    <span class="svg-icon menu-icon svg-icon-primary">
                                    ...
                                    <span class="menu-text">Pembayaran Kas</span>
                                </a>
                            </li>
                            <!--END MENU PEMBAYARAN KAS-->
                        </ul>
                        ...
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item menu-item-submenu " aria-haspopup="true" data-menu-toggle="hover">
                                <a href="/pembayaranca" class="menu-link menu-toggle">
                                    ...
                                    <span class="menu-text">Pembayaran CA</span>
                                </a>
                            </li>
                            <!--END MENU PEMBAYARAN CA-->
                        </ul>
                ...
                <li class="menu-item menu-item-submenu " aria-haspopup="true" data-menu-toggle="hover">
                    <a href="javascript:;" class="menu-link menu-toggle">
                        ...
                        <span class="menu-text">Reimbuse</span>
                        <i class="menu-arrow"></i>
                    </a>
                    <div class="menu-submenu">
                        <i class="menu-arrow"></i>
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item " aria-haspopup="true">
                                <a href="/pegajuan_reimbuse" class="menu-link">
                                    ...
                                    <span class="menu-text">Pengajuan Reimbuse</span>
                                </a>
                            </li>
                            ...
                            <li class="menu-item menu-item-submenu " aria-haspopup="true" data-menu-toggle="hover">
                                <a href="reimbuse" class="menu-link menu-toggle">
                                    ...
                                    <span class="menu-text">Pembayaran Reimbuse</span>
                                </a>
                            </li>
                            <!--END MENU PEMBAYARAN REIMBUSE-->
                        </ul>
                ...
                <li class="menu-item menu-item-submenu " aria-haspopup="true" data-menu-toggle="hover">
                    <a href="javascript:;" class="menu-link menu-toggle">
                        ...
                        <span class="menu-text">Tambahan</span>
                        <i class="menu-arrow"></i>
                    </a>
                    <div class="menu-submenu">
                        <i class="menu-arrow"></i>
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item " aria-haspopup="true">
                                <a href="" class="menu-link">
                                    ...
                                    <span class="menu-text">Pengajuan Tambahan</span>
                                </a>
                            </li>
                            <!-- END MENU PENGAJUAN Tambahan -->
                            <!-- END MENU PEMBAYARAN Tambahan-->
                            <li class="menu-item menu-item-submenu " aria-haspopup="true" data-menu-toggle="hover">
                                <a href="javascript:;" class="menu-link menu-toggle">
                                    <span class="svg-icon menu-icon svg-icon-primary">
                                        <!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Files\Export.svg-->
                                    ...
                                    <span class="menu-text">Pembayaran Tambahan</span>
                                </a>
                            </li>
                            <!--END MENU PEMBAYARAN Tambahan-->
                        </ul>
                ...
                <li class="menu-item menu-item-submenu " aria-haspopup="true" data-menu-toggle="hover">
                    ...
                    <div class="menu-submenu">
                        ...
                        <ul class="menu-subnav">
                            ...
                            <!--MENU PENGAJUAN BANK -->
                            <li class="menu-item " aria-haspopup="true">
                                <a href="{{ url('/pengajuandanabank') }}" class="menu-link">
                                    <span class="svg-icon menu-icon svg-icon-primary">
                                        <!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Shopping\Chart-bar1.svg-->
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                    ...
                                    <span class="menu-text">Pengajuan Dana Bank</span>
                                </a>
                            </li>
                            <!-- END MENU PENGAJUAN REIMBUSE -->
                            <!-- END MENU Penerimaan Bank-->
                            <li class="menu-item menu-item-submenu " aria-haspopup="true" data-menu-toggle="hover">
                                <a href="{{ url('/penerimaanbank') }}" class="menu-link menu-toggle">
                                    <span class="svg-icon menu-icon svg-icon-primary">
                                        <!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Files\Export.svg-->
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                    ...
                                    <span class="menu-text">Penerimaan Bank</span>
                                </a>
                            </li>
                            <!--END MENU Penerimaan Bank-->
                            <!-- END MENU PEMBAYARAN Bank-->
                            <li class="menu-item menu-item-submenu " aria-haspopup="true" data-menu-toggle="hover">
                                <a href="{{ url('/pembayaranbank') }}" class="menu-link menu-toggle">
                                    <span class="svg-icon menu-icon svg-icon-primary">
                                        <!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Files\Export.svg-->
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                    ...
                                    <span class="menu-text">Pembayaran Bank</span>
                                </a>
                            </li>
                            <!--END MENU PEMBAYARAN Bank-->
                        </ul>
                ...
                <!-- START KELOLA USER MENU -->
                <li class="menu-item " aria-haspopup="true">
                    <a href="{{ url('/datauser') }}" class="menu-link">
                        <span class="svg-icon menu-icon svg-icon-primary">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <!-- START Laporan MENU -->
                <li class="menu-item " aria-haspopup="true">
                    <a href="{{ url('/laporan-bendahara') }}" class="menu-link">
                        <span class="svg-icon menu-icon svg-icon-primary">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <li class="menu-item menu-item-submenu " aria-haspopup="true" data-menu-toggle="hover">
                    ...
                    <div class="menu-submenu">
                        ...
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item " aria-haspopup="true">
                                <a href="{{ url('/profile-bendahara') }}" class="menu-link">
                                    <span class="svg-icon menu-icon svg-icon-primary">
                                        <!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Shopping\Chart-bar1.svg-->
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                            ...
                            <li class="menu-item menu-item-submenu " aria-haspopup="true" data-menu-toggle="hover">
                                <a href="{{ url('/change-password-bendahara') }}" class="menu-link menu-toggle">
                                    <span class="svg-icon menu-icon svg-icon-primary">
                                        <!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Files\Export.svg-->
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
