...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('tb_penerimaan_antar_bank', function (Blueprint $table) {
            $table->uuid('id_penerimaan_antar_bank', 40)->primary()->comment('UUID');
    ...
    {
        Schema::dropIfExists('tb_penerimaan_antar_bank');
    }
};
